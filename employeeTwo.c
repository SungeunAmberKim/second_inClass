...
// What does setting a function to static do? == this function only can be used in this file
// functionPtr is the address of the fucntion just use the name
...
// The functionPtr will point to one of these comparison fuctions to perform a check
...
{
    return *(long*)targetPtr != tableValuePtr->salary;  // const void *targetPtr ==> typecast as int pointer
}
